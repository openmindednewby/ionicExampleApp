...
import { triangle, ellipse, square, camera, image, save, search, download, listCircle, cog, help } from 'ionicons/icons';
...
export class AppComponent {
  ...
  constructor() {
    addIcons({ triangle, ellipse, square, camera, image, save, search, download, listCircle, cog, help });
